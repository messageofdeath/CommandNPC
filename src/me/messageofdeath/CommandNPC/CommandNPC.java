...
import me.messageofdeath.CommandNPC.Listener.NPCListener;
import me.messageofdeath.CommandNPC.Utils.CitizenBackend.CitizenCommandRegister;
import me.messageofdeath.CommandNPC.Utils.NPCDataManager.NPCDataManager;
...
public class CommandNPC extends JavaPlugin {
	...
	public void logError(String topic, String classx, String method, String error) {
		...
		String text = "&cTopic";
		topic = "&c" + topic;
		this.log("&4---------------------&b{&2PaidRanks &cError&b}&4---------------------", false);
